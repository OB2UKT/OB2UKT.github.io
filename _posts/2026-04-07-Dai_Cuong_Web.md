...
categories: [ Base Web, Web Pentest]
tags: [Base Web, Knowledge]
math: true
mermaid: true
---
...
![Intercepted Request](assets/img/material_posts/Dai_Cuong_Web/img1.png){: width="800" height="500" }
_Hình 1: Mô hình so sánh HTTP version 1.1 và 2.0._
...
![Intercepted Request](assets/img/material_posts/Dai_Cuong_Web/img2.png){: width="800" height="500" }
_Hình 2: Cấu trúc HTTP Request._
...
![Intercepted Request](assets/img/material_posts/Dai_Cuong_Web/img3.png){: width="800" height="500" }
_Hình 3: Cấu trúc HTTP Response._
